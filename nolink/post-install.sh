...
yay -S spotify ffmpeg-compat-54 sgi-fonts conan dropbox toilet cava-git google-chrome-beta wire-desktop-bin visual-studio-code-bin clipmenu openvpn-update-systemd-resolved simple-mtpfs mons
