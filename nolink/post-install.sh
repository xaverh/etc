...
yay -S spotify ffmpeg-compat-54 sgi-fonts conan dropbox toilet cava-git google-chrome-beta wire-desktop-bin visual-studio-code-bin clipmenu openvpn-update-systemd-resolved simple-mtpfs mons openvpn-update-resolv-conf-git brave-bin
...
code --install-extension James-Yu.latex-workshop --install-extension Telerik.nativescript --install-extension bierner.markdown-checkbox --install-extension bierner.markdown-emoji --install-extension bierner.markdown-footnotes --install-extension bierner.markdown-mermaid --install-extension dbaeumer.vscode-eslint --install-extension eg2.ts-tslint --install-extension eg2.vscode-npm-script --install-extension hoovercj.vscode-settings-cycler --install-extension idleberg.emoji-code --install-extension lukehoban.Go --install-extension ms-python.python --install-extension ms-vscode.cpptools --install-extension msjsdiag.debugger-for-chrome --install-extension nhoizey.gremlins --install-extension octref.vetur --install-extension ravilang.ravi-debug --install-extension satoren.lualint --install-extension twxs.cmake --install-extension wmaurer.change-case --install-extension xaver.clang-format --install-extension xaver.theme-qillqaq --install-extension xaver.theme-ysgrifennwr

npm install --global eslint eslint-config-standard eslint-plugin-html eslint-plugin-import eslint-plugin-node eslint-plugin-promise eslint-plugin-standard eslint-plugin-vue generator-code gulp-cli typescript vsce vue-cli yo
