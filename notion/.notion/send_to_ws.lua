...
defbindings("WMPlex", {
	    kpress(META .. "Shift+1", "send_to_ws(_sub, 0, false)"),
	    kpress(META .. "Shift+2", "send_to_ws(_sub, 1, false)"),
	    kpress(META .. "Shift+3", "send_to_ws(_sub, 2, false)"),
	    kpress(META .. "Shift+4", "send_to_ws(_sub, 3, false)"),
	    kpress(META .. "Shift+5", "send_to_ws(_sub, 4, false)"),
	    kpress(META .. "Shift+6", "send_to_ws(_sub, 5, false)"),
