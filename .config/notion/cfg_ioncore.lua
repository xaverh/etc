...
defbindings("WMPlex.toplevel", {
	...
	bdoc("Start alsamixer for volume-settings"),
	kpress("XF86AudioMedia", "ioncore.exec_on(_, ':alsamixer')"),
	
	bdoc("Tune down with amixer"),
	kpress("XF86AudioLowerVolume", "ioncore.exec_on(_, 'amixer -c 0 -- sset Master,0 5%-,5%-')"),

	bdoc("Tune up with amixer"),
	kpress("XF86AudioRaiseVolume", "ioncore.exec_on(_, 'amixer -c 0 -- sset Master,0 5%+,5%+')"),

	bdoc("Access e-mail with Thunderbird"),
	kpress("XF86Mail", "ioncore.exec_on(_, 'thunderbird')"),

	bdoc("Print Screen with PrtScr"),
