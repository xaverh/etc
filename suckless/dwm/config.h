...
/* tagging */
static const char* tags[] = {"1", "2", "4", "8"};
...
static const Rule rules[] = {
    ...
    {"mpv", "gl", NULL, 1 << 7, 0, -1},
    {NULL, "journalctl", NULL, 1 << 7, 0, -1},
    {"mpv", "FM0", NULL, 1 << 8, 0, -1},
    {NULL, NULL, "MuPDF:", 1 << 4, 0, -1},
    {NULL, NULL, ".epub -", 1 << 4, 0, -1},
    {NULL, NULL, ".pdf -", 1 << 4, 0, -1},
    {NULL, NULL, ".cbz -", 1 << 4, 0, -1},
    {NULL, NULL, ".EPUB -", 1 << 4, 0, -1},
    {NULL, NULL, ".PDF -", 1 << 4, 0, -1},
    {NULL, NULL, ".CBZ -", 1 << 4, 0, -1},
    {NULL, NULL, "Picture in picture", 1 << 7, 0, -1},
    {"Spotify", NULL, NULL, 1 << 3, 0, -1},
    {"strawberry", NULL, NULL, 1 << 3, 0, -1},
    {"Steam", NULL, NULL, 1 << 6, 0, -1},
    {"TelegramDesktop", NULL, NULL, 1 << 5, 0, -1},
    {NULL, "weechat", NULL, 1 << 5, 0, -1},
};
...
static const char* dmenucmd[] = {"rofi",  "-combi-modi", "window,drun,run",
                                 "-show", "combi",       "-modi",
                                 "combi", NULL};
#define TERMCMD "alacritty"
...
static const char* journalctlcmd[] = {
    ...
    " -e --class journalctl -T journalctl -- journalctl -b -f -n 1000",
    NULL};
static const char* irccmd[] = {SHELL, "-c",
                               "pidof weechat || " TERMCMD
                               " -e --class weechat -T weechat -- weechat",
                               NULL};
...
#define SSHADDKEYCMD                                                           \
	TERMCMD                                                                \
	" -e --class=Kittyaskpass --override 'initial_window_width=56c' "      \
...
static char const* kittybrightcmd[] = {
    "/bin/zsh", "-c",
    "kitty @ --to unix:@mykitty get-colors | grep -q '#1e1e1e' && kitty @ "
    "--to "
    "unix:@mykitty set-colors -a -c foreground='#424242' "
    "background='#f9f8f4' "
