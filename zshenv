...
export TERM CFLAGS CXXFLAGS FCFLAGS FFLAGS XDG_CONFIG_DIRS LDFLAGS MAKEFLAGS
...
[[ -e /home/xha/.nix-profile/etc/profile.d/nix.sh ]] && . /home/xha/.nix-profile/etc/profile.d/nix.sh
