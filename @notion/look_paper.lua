...
basefont = "xft:Input Sans Compressed:size=9:weight=bold"
tabfont = "xft:Input Sans Compressed:size=8:weight=bold"
menufont = "xft:Input Sans Compressed:size=10:weight=bold"
...
local tab_line = 2
decoration = {
	active = {background = '#5d4d7a', foreground = {default = 'grey', selected = '#ffffff'}},
	inactive = {
		background = '#212026',
		foreground = {default = '#9aa28b', selected = '#eeeeee'},
		sp = {background = '#1d4d7a', foreground = {default = 'grey', selected = '#ffffff'}}
	},
	preview = {background = '#4E4B59', foreground = {default = 'grey', selected = '#ffffff'}}
}
...
de.defstyle('*', {
	...
	font = 'xft:Input Sans Compressed:size=14',
	text_align = 'center'
})
...
de.defstyle('tab', {
	font = 'xft:Input Sans Compressed:size=12',
	show_icon = true,
...
de.defstyle('input', {
	text_align = 'left',
	font = 'xft:Input Sans Compressed:size=15',
	spacing = 0,
	border_style = 'elevated',
	border_sides = 'tb',
	...
	de.substyle('*-selection', {background_colour = '#9a9292', foreground_colour = '#000000'}),

	de.substyle('*-cursor', {background_colour = '#ffffff', foreground_colour = '#9999aa'})
})

de.defstyle('tab-menuentry',
            {highlight_pixels = 0, shadow_pixels = 0, padding_pixels = 1, text_align = 'left'})

de.defstyle('tab-menuentry-big', {font = 'xft:Input Sans Compressed:size=14', padding_pixels = 7})
...
de.defstyle('frame-floating-alt', {
	...
	highlight_pixels = 8,
	shadow_pixels = 8,
	highlight_colour = decoration.inactive.sp.foreground.default,
	shadow_colour = decoration.inactive.sp.foreground.default,
