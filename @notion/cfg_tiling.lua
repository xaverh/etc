...
defctxmenu("WTiling", "Tiling", {
    ...
    menuentry("Into rows", "WTiling.split_at(_, _sub, 'bottom', true)"),
    menuentry("Into columns", "WTiling.split_at(_, _sub, 'right', true)"),
    ...
    submenu("At root", {
        menuentry("Into rows", "WTiling.split_top(_, 'bottom')"),
        menuentry("Into columns", "WTiling.split_top(_, 'right')"),
